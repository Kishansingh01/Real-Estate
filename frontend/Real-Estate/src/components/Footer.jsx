          ...
          <div className="container mx-auto flex flex-col md:flex-row justify-between items-start">
            <div className="w-full md:w-1/3 mb-8 md:mb-0">
                ...
                <p className="text-gray-400 mt-4">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                    Quisquam velit itaque consectetur id minima dicta aperiam     
                </p>
            </div>
            ...
            <div className="w-full md:w-1/3">
                 ...
                 <p className="text-gray-400 mb-4 max-w-80">The latestnews,articles,and resources,
                    sent to your inbox weeekly  
                 </p>
                 <div className="flex gap-2">
                    <input type="email" placholder="Ender your Email" 
