...
const Contact=()=>{
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "a076bd8e-0a0e-46d6-aec4-07ca05b86be5");
            ...
            <form onSubmit={onSubmit} className="max-w-2xl mx-auto text-gray-600 pt-8">
                <div className="flex flex-wrap"> 
                    <div className="w-full md:w-1/2 text-left">
                         Your Name
                         <input className="w-full border border-gray-300 rounded py-3 px-3 mt-2" 
                         type="text" placeholder="Your Name" name="Name" required/>
                    </div>
                     <div className="w-full md:w-1/2 text-left md:pl-4">
                         Your Email
                         <input className="w-full border border-gray-300 rounded py-3 px-3 mt-2" 
                         type="email" placeholder="Your Email" name="Eame" required/>
                    </div>
                </div>
                ...
                <button className="bg-blue-600 text-white py-2 px-12 mb-12 rounded">
                   {
